							...
							<div className='lg:grid lg:grid-cols-12'>
								<div className='z-20 px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center'>
									<div>
										...
										<a
											href='/'
											className='mt-12 start-now-btn inline-flex items-center text-white bg-gray-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base'
										>
											<span className='ml-4 text-sm'>Contact Us</span>
											<svg
								...
								<div className='z-20 sm:z-20 lg:z-20 md:z-20 lg:col-span-6'>
									<div
										className='relative'
										aria-hidden='true'
										style={{ height: "100%" }}
